...
export default function FinalReportListView() {
  ...
  const editor = useDocEditor({
    keyPrefix: 'file-report',
    lockPath: (id) => `/file-reports/${id}/lock`,
    uploadPath: (id) => `/file-reports/${id}/file`,
    downloadFile: (id) => ApiClient.get(`/file-reports/${id}/download`),
    onReleased: load,
  });

  async function forceUnlock(id) {
    try {
      await ApiClient.delete(`/file-reports/${id}/lock`);
