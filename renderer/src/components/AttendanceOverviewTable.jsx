...
function SummaryBadge({ label, count, meta }) {
  return (
    <span style={{
  ...
  return (
    <div>
      ...
      <Row gutter={8} style={{ marginBottom: 16 }} align="middle">
        <Col><SummaryBadge label="Present" count={counts.present} meta={STATUS_META.present} /></Col>
        <Col><SummaryBadge label="Absent" count={counts.absent} meta={STATUS_META.absent} /></Col>
        <Col><SummaryBadge label="Pending" count={counts.pending} meta={STATUS_META.pending} /></Col>
        {graceEnd && (
          <Col>
